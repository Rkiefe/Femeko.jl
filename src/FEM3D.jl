...
function GaussQuadrature3D(precision::Integer)
    ...
    if precision == 1
        ...
        weights = [0.25 0.25 0.25 0.25]./6.0
    ...
    elseif precision == 2
        ...
        weights = [-0.8 0.45 0.45 0.45 0.45]./6.0;
